...
const initialPeople: UserType[] = [
    ...
    {_id: 0, name: 'Кошка Белка', age: 3},
    {_id: 1, name: 'Александр Македонский', age: 66},
    {_id: 2, name: 'Николай Николаевич', age: 16},
    {_id: 3, name: 'Виктор Литвин', age: 44},
    {_id: 4, name: 'Дмитрий Кузюбердин', age: 33},
    {_id: 5, name: 'Роман Чучвал', age: 29},
]
