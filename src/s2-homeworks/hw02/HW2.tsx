...
export const filterAffairs = (affairs: Array<AffairType>, filter: string): Array<AffairType> => { // need to fix any +++
    ...
    return filter === 'all' ? affairs.filter(el => el) : affairs.filter(el => el.priority === filter)
}
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => { // need to fix any
        let updatedAffairsList = affairs.filter(el => el._id !== _id)
        setAffairs(updatedAffairsList)
        // need to fix
    }
